...
/**
 * MagicRings — vendored from react-bits (MIT + Commons Clause), by David Haz.
 * https://reactbits.dev/animations/magic-rings
 *
 * Kept as-is apart from the 'use client' directive the App Router needs; tune it
 * through props at the call site, not by editing here, so it stays diffable
 * against upstream.
 */
